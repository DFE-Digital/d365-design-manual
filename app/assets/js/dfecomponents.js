...
DfEComponents.initAll = function (options) {
  ...
  var $searchableTables = scope.querySelectorAll('[data-module="dfe-searchable-table"]');
  DfEComponents.nodeListForEach($searchableTables, function ($table) {
    new DfEComponents.SearchableTable({
      table: $table
    });
  });
}
...
DfEComponents.SearchableTable = function(params) {
	this.table = $(params.table);
...
DfEComponents.SearchableTable.prototype.setupOptions = function(params) {
	params = params || {};
